...
// Source: OWSProvisioningProtos.proto
//
...
extension Signalservice_ProvisionEnvelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Signalservice_ProvisionEnvelope) -> Bool {
...
extension Signalservice_ProvisionMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Signalservice_ProvisionMessage) -> Bool {
