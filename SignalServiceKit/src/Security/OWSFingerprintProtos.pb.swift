...
// Source: OWSFingerprintProtos.proto
//
...
extension Textsecure_LogicalFingerprints: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Textsecure_LogicalFingerprints) -> Bool {
