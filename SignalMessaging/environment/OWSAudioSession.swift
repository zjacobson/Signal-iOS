...
public class OWSAudioSession: NSObject {
    ...
    public func setPlaybackCategory() {
        ...
        assert(avAudioSession.category == AVAudioSessionCategoryAmbient)
    ...
    public func endAudioActivity() {
        ...
        // This wouldn't strictly break anything, but in general we only
        // call endAudioActivity after the user finishes some task which
        // required modifying the audio category.
        assert(avAudioSession.category != AVAudioSessionCategoryAmbient)
